...
<html lang="ID-id">
  <head>
    ...
    <link rel="icon" href="<?php echo base_url('assets/uploads/sites/ltf.png'); ?>" type="image/icon">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo get_store_logo(); ?>" class="brand-link">
      <img src="<?php echo get_store_logo(); ?>" alt="<?php echo get_store_name(); ?> Logo" class="brand-image "
           style="opacity: .8">
