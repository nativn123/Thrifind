...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bgcuy.png'); ?>');">
    <div class="container">
  ...
  <section class="ftco-section contact-section bg-light">
    <div class="container">
        ...
        <div class="col-md-3 d-flex">
            <div class="info bg-white p-4">
              <p><span>Website</span> www.thrifind.com</p>
            </div>
        </div>
      </div>
      <div class="row block-9">
        ...
        <div class="col-md-6 d-flex">
            <div style="width: 100%">
                <iframe width="100%" height="600" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;coord=-3.7576348,102.2873882&amp;q=Kost%20Indah%20Jaya%20Belakang%20No.%2024%2C%20Jl.%20Medan%20Baru%20VI%2C%20Kandang%20Limun%2C%20Bengkulu+(Toko%20Sayur%2022)&amp;ie=UTF8&amp;t=&amp;z=15&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0">
