...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bgcuy.png'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">2024 BEST THRIFT FIT!</h1>
            <h2 class="subheading mb-4">Explore top brands high-quality second-hand clothing at affordable prices.</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bgnih.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Experience 2024's Top Thrift Trends</h1>
            <h2 class="subheading mb-4">Explore top brands high-quality second-hand clothing at affordable prices.</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          <h3 class="heading">Trending Fashion</h3>
          <span>Selalu Mengikuti Trend Fashion</span>
        </div>
      </div>    
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
